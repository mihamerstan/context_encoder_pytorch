...
input_real = torch.FloatTensor(1, opt.imageSize, opt.imageSize)
input_cropped = torch.FloatTensor(1, opt.imageSize, opt.imageSize)
real_center = torch.FloatTensor(1, old_div(opt.imageSize,2), old_div(opt.imageSize,2))
...
input_cropped.data[:,old_div(opt.imageSize,4)+opt.overlapPred:old_div(opt.imageSize,4)+old_div(opt.imageSize,2)-opt.overlapPred,old_div(opt.imageSize,4)+opt.overlapPred:old_div(opt.imageSize,4)+old_div(opt.imageSize,2)-opt.overlapPred] = 0
