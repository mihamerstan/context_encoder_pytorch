...
from model_small import _netlocalD,_netG
import utils
...
real_center = torch.FloatTensor(opt.batchSize, 3, old_div(opt.imageSize,8), old_div(opt.imageSize,8))
...
for epoch in range(resume_epoch,opt.niter):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        real_center_cpu = real_cpu[:,:,56:72,56:72]
        ...
        wtl2Matrix.data[:,:,int(opt.overlapPred):int(16 - opt.overlapPred),int(opt.overlapPred):int(16 - opt.overlapPred)] = wtl2
