...
for i in range(1,101):
    ...
    t = old_div(img[32:32+64,32:32+64,:].astype(np.float32),127.5)-old_div(dst[32:32+64,32:32+64,:].astype(np.float32),127.5)
    l2 = l2 + np.mean(np.square(t))
    t = np.abs(t)
    l1 = l1 + np.mean(t)

print(old_div(l1,100.0))
print(old_div(l2,100.0))
print(old_div(p,100.0))
